...
MWire
{
    Shape
    {
        ...
        ShapePath
        {
            ...
            Behavior on strokeWidth{NumberAnimation {duration: WireStyle.transmittingAnimationTime()}}
        ...
        ShapePath
        {
            strokeWidth: selected ? WireStyle.selectedLineWidth() : 2
            strokeColor: selected ? WireStyle.selectedColor() : "black"
            fillColor: "transparent"
            startX: outPoint.x
            startY: outPoint.y
